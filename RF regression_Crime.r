...
#1.3 A power transformation of the SKIP
#    crime rate.   
...
varNam6<-c("PctKidsBornNeverMar","racepctblack", "racePctWhite","PctPopUnderPov"
           ,"FemalePctDiv","HousVacant" )
set.seed(853)
crimeFocus6 <- randomForest(x = crimeReg[, varNam5], y=crimeReg[,81],
                            mtry=2, importance=TRUE, proximity=FALSE, ntree=500, keepForest=FALSE)
crimeFocus6
...
#cases. The hclust() function doesnt' #like large
