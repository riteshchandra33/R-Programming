...
dev.off()
#when you open a pdf command you have to close it using dev.off() 
...
# Example 06 - horizontal stacked (segmented) bars
#     segbar plots the input data, normbar plots percent of total
#     package computes the percents from input data
#     input for the categories for each state must be in consecutive 
...
# Example 07 - centered (diverging) stacked bars
#
...
panelDesc07 <- data.frame(                 
  ...
  lab1=c(NA,NA,"Avg. Scores","Math Proficiency"),         
  lab2=c(NA,NA,NA,"<Basic, Basic, Proficient, Advanced"),  
  lab3=c(NA,NA,NA,"% to Left of 0           |    % to Right"),  
...
panelDesc08 = data.frame(
  ...
  ,lab1=c(NA,NA,"Rate Trend APC", "Rate Change")  
  ,lab2=c(NA,NA,"Dot-Signif","2002-06 to 2007-11") 
  ,lab3=c(NA,NA,NA,NA) 
...
# Example 09 - A linked micromap of the counties of the state
...
panelDesc09 = data.frame(
  ...
  ,lab1=c(NA,NA,"Population", "Average Inc.")  
  ,lab2=c(NA,NA,"in 2000","per year") 
  ,lab3=c(NA,NA,"UNITS",NA) 
...
#  Example 11 - A linked micromap of the counties of the state
...
panelDesc11 <- data.frame(
  ...
  ,lab1=c(NA,  NA,  "Population in", "Increase from","Pop 2005","Incre")  
  ,lab2=c(NA,  NA,  "2010",          "2000",         NA,        "2000to2010") 
  ,lab3=c(NA,  NA,  NA,              NA,             NA,        NA) 
  ,col1=c(NA,  NA,  "Pop_2010",      "Pop_2000",     "Pop_2000","Dif00_10")
  ,col2=c(NA,  NA,  NA,              "Pop_2010",     NA,        NA)
...
# Example 12 - A linked micromap of the counties of 
...
panelDesc12 = data.frame(
  ...
  ,lab1=c(NA,NA,"Population", "Population","Change")  
  ,lab2=c(NA,NA,"in 1970","in 2000", "from 1970 to 2000") 
  ,lab3=c(NA,NA,NA,NA,NA) 
  ,col1=c(NA,NA,"X1970","X2010","X1970")
  ,col2=c(NA,NA,NA,NA,"X2010")
) 
...
# Example 13 - A linked micromap of the provinces, municipalities,
...
panelDesc13 = data.frame(
  ...
  ,lab1=c(NA,NA,"Population", "Population")  
  ,lab2=c(NA,NA,"in 2013","in 2013") 
  ,lab3=c(NA,NA,NA,NA) 
...
# Example 14 - A linked micromap of the districts 
...
panelDesc14 = data.frame(
  type=c("map","id","dot","bar")    
  ,lab1=c(NA,NA,"Population", "Area")  
  ,lab2=c(NA,NA,"in 2012","in 2012") 
  ,lab3=c(NA,NA,NA,"sqkm") 
...
#   Example 15 - A linked micromap of the counties in the 
...
panelDesc15 = data.frame(
  ...
  ,lab1=c(NA,NA,"Population", "2001-2011","Chg 1991-2001")  
  ,lab2=c(NA,NA,"in 2011","pop change","pop change") 
  ,lab3=c(NA,NA,NA,NA,NA) 
...
panelDesc16 <- data.frame(type = c("maptail", "id", "dot"),
                          lab1 = c(NA, NA, "Murder"),
                          lab3 = c(NA, NA, "Murders per 100K Population"),
                          col1 = c(NA, NA, 5))
...
panelDesc18 <- data.frame(type = c("map", "id", "dot",      "dot",          "dot"),
                          lab1 = c(NA,      NA,"Population","Percentage Of","Est x2 Time"),
                          lab3 = c(NA,      NA,"People",    "Total",        "Years"),
