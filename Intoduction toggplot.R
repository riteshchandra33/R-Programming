...
#opens a seperate window to view the data
View(faithful)
...
head(faithful)#first 6 rows of the dataset
tail(faithful)#last 6 rows of the dataset
...
ggplot(faithful2,aes(x=waiting,y=eruptions))+
  geom_point()
cor(faithful2$waiting, faithful2$eruptions)#calculating co-relation coefficient
...
#pdf("scatterplot.pdf", width = 4, hright = 6)adding aspect ratio
pdf("scatterplot.pdf")
ggplot(faithful2,aes(x=waiting,y=eruptions))+
